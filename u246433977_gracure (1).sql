...
--
-- Constraints for table `td_lifestyle_bonus`
--
ALTER TABLE `td_lifestyle_bonus`
  ADD CONSTRAINT `fk_referral_lifestyle` FOREIGN KEY (`referral_bonus_id`) REFERENCES `td_referral_bonus` (`id`);
...
--
-- Constraints for table `td_messages`
--
ALTER TABLE `td_messages`
  ADD CONSTRAINT `fk_member_message` FOREIGN KEY (`member_id`) REFERENCES `td_members` (`id`);

--
-- Constraints for table `td_referral_bonus`
--
ALTER TABLE `td_referral_bonus`
  ADD CONSTRAINT `fk_deposit_ref_bonus` FOREIGN KEY (`deposit_id`) REFERENCES `td_deposits` (`id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_member_bonus` FOREIGN KEY (`referrer_id`) REFERENCES `td_members` (`id`) ON UPDATE CASCADE;

--
-- Constraints for table `td_withdrawals`
--
ALTER TABLE `td_withdrawals`
  ADD CONSTRAINT `fk_member_withdrawal` FOREIGN KEY (`member_id`) REFERENCES `td_members` (`id`);

--
-- Constraints for table `td_withdrawal_mode`
--
ALTER TABLE `td_withdrawal_mode`
  ADD CONSTRAINT `fk_member_accounts` FOREIGN KEY (`member_id`) REFERENCES `td_members` (`id`);
COMMIT;
