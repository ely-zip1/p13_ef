                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6 deposit-form">
                                    ...
                                    <div class="input-group-text">https://coralgold.org/my/ref/</div>
                                        ...
                                        <input name="receiver_code" type="text"
                                            class="form-control <?php if(strlen(form_error('receiver_code')) > 0){echo "is-invalid";} ?>"
                                            id="inlineFormInputGroup" placeholder=""
                                            value="<?php set_value('receiver_code','',true); ?>">
                                ...
                                <div class="form-group col-md-6  deposit-form">
                                    ...
                                    <input type="text"
                                        ...
                                        value="<?php set_value('transfer_amount','',true); ?>">
                                    <div class="invalid-feedback deposit-error">
