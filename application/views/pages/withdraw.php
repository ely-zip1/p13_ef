                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-12 withdraw-form" hidden>
                                                    ...
                                                    <select class="form-control" name="withdrawal_source">
                                                        <option
                                                            <?php if($selected_source == 'account_balance') {echo 'selected';} ?>
                                                            value="account_balance">Account Balance</option>
                                                        <option
                                                            <?php if($selected_source == 'bonus') {echo 'selected';} ?>
                                                ...
                                                <div class="form-group col-12 withdraw-form">
                                                    ...
                                                    <select class="form-control" name="plan_payment_mode">
                                                        <option
                                                            <?php if($selected_mode == 'mode1') {echo 'selected';} ?>
                                                            value="mode1">Bank</option>
                                                        <option
                                                            <?php if($selected_mode == 'mode2') {echo 'selected';} ?>
                                                            value="mode2">Bitcoin</option>
                                                        <option
                                                            <?php if($selected_mode == 'mode3') {echo 'selected';} ?>
                                                            value="mode3">Ethereum</option>
                                                        <option
                                                            <?php if($selected_mode == 'mode4') {echo 'selected';} ?>
                                                            value="mode4">Ripple (XRP)</option>
                                                        <option
                                                            <?php if($selected_mode == 'mode5') {echo 'selected';} ?>
                                                            value="mode5">Tron (TRX)</option>
                                                        <option
                                                            <?php if($selected_mode == 'mode10') {echo 'selected';} ?>
                                                            value="mode10">Litecoin</option>
                                                        <option
                                                            <?php if($selected_mode == 'mode11') {echo 'selected';} ?>
                                                ...
                                                <div class="form-group col-12">
                                                    ...
                                                    <button type="submit" class="btn btn-block btn-lg withdraw_button"
